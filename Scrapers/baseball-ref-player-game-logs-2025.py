...
class GameLogDownloader:
    def __init__(self, end_year: int = 2025, years_count: int = 1):
        # Define the range of years to download (only the 2025 season)
        self.years = [2025]
...
async def main(test: bool = False):
    ...
    downloader = GameLogDownloader(end_year=2025, years_count=1)

...
# ===========================
#xvfb-run "$HOME/.pyenv/shims/python" bovada_scrape_game_urls.py >> scraper.log 2>&1
#xvfb-run "$HOME/.pyenv/shims/python" bovada_scrape_pitcher_props.py >> scraper.log 2>&1
/usr/bin/xvfb-run -a "$HOME/.pyenv/shims/python" bovada_scrape_game_urls_playwright.py >> scraper.log 2>&1
/usr/bin/xvfb-run -a "$HOME/.pyenv/shims/python" bovada_scrape_pitcher_props_playwright.py >> scraper.log 2>&1


# ===========================
# Run the fanduel alt lines scraper
# ===========================
#xvfb-run "$HOME/.pyenv/shims/python" fanduel_scrape_pitcher_props_theoddsapi_working.py >> scraper.log 2>&1
...
"$HOME/.pyenv/shims/python" statsapi_team_game_logs.py >> scraper.log 2>&1
echo "Fetching pitcher game logs …" >> scraper.log 2>&1
"$HOME/.pyenv/shims/python" statsapi_pitcher_game_logs.py >> scraper.log 2>&1
echo "Fetching batter game logs …" >> scraper.log 2>&1
"$HOME/.pyenv/shims/python" statsapi_batter_game_logs.py >> scraper.log 2>&1
echo "Fetching all player season stats …" >> scraper.log 2>&1
"$HOME/.pyenv/shims/python" statsapi_player_season_stats.py >> scraper.log 2>&1
echo "Fetching bvp matchup stats …" >> scraper.log 2>&1
"$HOME/.pyenv/shims/python" statsapi_bvp_matchup_stats.py >> scraper.log 2>&1
...
#     echo "$(date): Found login error in previous run, running signin script first" >> "$HOME/mlb-ai/Scrapers/scraper.log" 2>&1
#     # Run the signin script
#     xvfb-run "$HOME/.pyenv/shims/python" ballparkpal_signin_auto.py >> scraper.log 2>&1

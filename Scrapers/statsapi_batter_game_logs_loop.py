...
def fetch_all_batters_gamelogs(season):
    ...
    df_batters.to_csv(f"data/{season}/batters_gamelogs_{season}_statsapi.csv", index=False)
    df_batter_details.to_csv(f"data/{season}/batters_details_{season}_statsapi.csv", index=False)

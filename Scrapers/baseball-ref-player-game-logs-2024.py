...
class GameLogDownloader:
    def __init__(self, end_year: int = 2024, years_count: int = 1):
        # Define the range of years to download (only the 2024 season)
        self.years = [2024]
...
async def main(test: bool = False):
    ...
    downloader = GameLogDownloader(end_year=2024, years_count=1)
